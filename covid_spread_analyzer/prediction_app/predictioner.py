...
class Predictioner:
    ...
    def setup_model(self):
        self.model.add(Dense(6, input_dim=1, activation='softmax', kernel_initializer='he_uniform'))
        self.model.add(Dense(16, activation='tanh', kernel_initializer='he_uniform'))
        self.model.add(Dense(12, activation='tanh', kernel_initializer='he_uniform'))
        self.model.add(Dense(8, activation='relu', kernel_initializer='he_uniform'))
        self.model.add(Dense(6, activation='tanh', kernel_initializer='he_uniform'))
        self.model.add(Dense(2, activation='tanh', kernel_initializer='he_uniform'))
