"""
Django settings for covid_spread_analyzer project.
...
SECRET_KEY = 's9izryt0mrx362$sljk!a#%aou-#^%($sgjon8$xjyfd5i*n_^'
...
ROOT_URLCONF = 'covid_spread_analyzer.urls'
...
WSGI_APPLICATION = 'covid_spread_analyzer.wsgi.application'
